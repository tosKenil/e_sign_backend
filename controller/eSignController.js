...
const { generatePdfDocumentFromTemplate, buildFullPdfHtml, getCurrentDayInNumber, getCurrentMOnth, getCurrentYear } = require("../middleware/helper");
...
eSignController.completeEnvelope = async (req, res) => {
    ...
    try {
        ...
        env.signers[idx].ipAddress = ipAddress || "";
